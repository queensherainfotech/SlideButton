package com.queensherainfotech.slidebuttonlibrary;
...
import static com.queensherainfotech.slidebuttonlibrary.Util.spToPx;
...
public class SlideView extends RelativeLayout implements SeekBar.OnSeekBarChangeListener{
    ...
    void init(AttributeSet attrs, int defStyle) {
        ...
        setBackground(ContextCompat.getDrawable(getContext(), R.drawable.view_bg));
        slideTextView = findViewById(R.id.text);
